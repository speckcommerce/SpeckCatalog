...
CREATE SCHEMA IF NOT EXISTS `swm_new_clean` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ;
USE `swm_new_clean` ;

-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_product_type`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_product_type` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_company`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_company` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_product`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_product` (
  ...
  CONSTRAINT `fk_product_product_type_id`
    ...
    REFERENCES `swm_new_clean`.`catalog_product_type` (`product_type_id` )
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_product_manufacturer_company_id`
    FOREIGN KEY (`manufacturer_id` )
    REFERENCES `swm_new_clean`.`catalog_company` (`company_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_product_uom`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_product_uom` (
  ...
  CONSTRAINT `fk_catalog_product_uom_uom_code`
    ...
    REFERENCES `swm_new_clean`.`ansi_uom` (`uom_code` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_catalog_product_uom_product_id`
    FOREIGN KEY (`product_id` )
    REFERENCES `swm_new_clean`.`catalog_product` (`product_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_availability`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_availability` (
  `product_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_catalog_availability_product_uom`
    ...
    REFERENCES `swm_new_clean`.`catalog_product_uom` (`product_id` , `uom_code` , `quantity` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_category`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_category` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`website`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`website` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_category_website`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_category_website` (
  ...
  CONSTRAINT `fk_catalog_category_linker_category_id`
    ...
    REFERENCES `swm_new_clean`.`catalog_category` (`category_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_catalog_category_linker_website_id`
    ...
    REFERENCES `swm_new_clean`.`website` (`website_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_category_product`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_category_product` (
  `category_id` INT NOT NULL ,
  `product_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_option`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_option` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_choice`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_choice` (
  ...
  CONSTRAINT `fk_catalog_choice_option_id`
    ...
    REFERENCES `swm_new_clean`.`catalog_option` (`option_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
PACK_KEYS = DEFAULT;
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_choice_option`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_choice_option` (
  ...
  CONSTRAINT `fk_catalog_choice_option_linker_2`
    ...
    REFERENCES `swm_new_clean`.`catalog_choice` (`choice_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_option_image`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_option_image` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_product_document`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_product_document` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_product_image`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_product_image` (
  `image_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `product_id` INT(11) NOT NULL ,
  `sort_weight` INT(11) NOT NULL DEFAULT '0' ,
  `file_name` VARCHAR(45) NULL ,
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_product_option`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_product_option` (
  `product_id` INT NULL ,
  `option_id` INT NULL ,
  `sort_weight` INT NOT NULL DEFAULT 0 ,
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`catalog_product_spec`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`catalog_product_spec` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`cart`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`cart` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`cart_item`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`cart_item` (
  ...
  CONSTRAINT `fk_cart_item_cart_id`
    FOREIGN KEY (`cart_id` )
    REFERENCES `swm_new_clean`.`cart` (`cart_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cart_item_item_id`
    FOREIGN KEY (`parent_item_id` )
    REFERENCES `swm_new_clean`.`cart_item` (`item_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`user`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`user` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`country_codes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`country_codes` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`address`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`address` (
  ...
  CONSTRAINT `fk_address_country_code`
    ...
    REFERENCES `swm_new_clean`.`country_codes` (`country_code` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`user_address`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`user_address` (
  ...
  CONSTRAINT `fk_user_address_user_id`
    FOREIGN KEY (`user_id` )
    REFERENCES `swm_new_clean`.`user` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_address_address_id`
    FOREIGN KEY (`address_id` )
    REFERENCES `swm_new_clean`.`address` (`address_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`order`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`order` (
...
-- -----------------------------------------------------
-- Table `swm_new_clean`.`order_log`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `swm_new_clean`.`order_log` (
  ...
  CONSTRAINT `fk_order_log_order_number`
    ...
    REFERENCES `swm_new_clean`.`order` (`order_number` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Data for table `swm_new_clean`.`catalog_product_type`
-- -----------------------------------------------------
START TRANSACTION;
USE `swm_new_clean`;
INSERT INTO `swm_new_clean`.`catalog_product_type` (`product_type_id`, `name`) VALUES (1, 'Shell');
INSERT INTO `swm_new_clean`.`catalog_product_type` (`product_type_id`, `name`) VALUES (2, 'Product');
