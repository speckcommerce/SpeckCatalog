...
ALTER TABLE `catalog_availability`
  ADD CONSTRAINT `fk_catalog_availability_dist` FOREIGN KEY (`distributor_id`) REFERENCES `contact_company` (`company_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `catalog_product`
  ADD CONSTRAINT `fk_product_product_type_id` FOREIGN KEY (`product_type_id`) REFERENCES `catalog_product_type` (`product_type_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
