...
CREATE TABLE IF NOT EXISTS `catalog_choice` (
  ...
  `price_override_fixed` decimal(15,5) NULL DEFAULT NULL,
  `price_discount_fixed` decimal(15,5) NULL DEFAULT NULL,
  `price_discount_percent` decimal(5,2) NULL DEFAULT NULL,
